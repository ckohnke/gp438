 ...
 * <p>
 * In particular, this program demonstrates how to implement a new mode of
...
public class PolesAndZeros {
  ...
  private static final int PZP_WIDTH = 600;
  private static final int PZP_HEIGHT = 640;
  ...
  private static final int RP_WIDTH = 700;
  private static final int RP_HEIGHT = 900;
  ...
  private class PoleZeroMode extends Mode {
    ...
    public PoleZeroMode(ModeManager modeManager, boolean forPoles) {
      ...
      if (forPoles) {
        _poles = true;
        setName("Poles");
        setIcon(loadIcon(PolesAndZeros.class,"Poles16.png"));
        ...
        _zeros = true;
        setName("Zeros");
        setIcon(loadIcon(PolesAndZeros.class,"Zeros16.png"));
